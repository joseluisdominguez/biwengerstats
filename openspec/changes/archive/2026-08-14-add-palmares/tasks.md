...
- [x] 9.4 Verificar tras el despliegue que la URL llega al bundle de producción y que el palmarés se ve en GitHub Pages — bundle `index-h2Ycaucy.js` con las tres URL (`gid=0`, `gid=924007710`, `gid=543593971`). La vista se sirve correctamente; la pestaña `Palmares` publicada solo tenía la fila de cabecera, así que muestra su estado vacío hasta que se rellenen los títulos. Es dato pendiente, no código
